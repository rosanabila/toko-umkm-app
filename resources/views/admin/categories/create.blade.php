...
<div class="dashboard-container">
    ...
    <div class="dashboard-content">
        <div style="margin-bottom: 2rem;">
            <h1 style="font-size: 2rem;">Tambah Kategori Baru</h1>
            <p style="color: var(--text-muted); margin-top: 0.25rem;">Buat kategori baru untuk mengelompokkan produk UMKM.</p>
        </div>
        ...
        <div class="glass-card" style="max-width: 600px; hover: none; padding: 1.5rem;">
            <form action="{{ route('admin.categories.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" class="form-control" placeholder="Contoh: Elektronik, Kerajinan Tangan" value="{{ old('name') }}" required>
                    <div id="name-error" style="color: var(--status-cancelled); font-size: 0.8rem; margin-top: 0.25rem; display: none;"></div>
                </div>

                <div style="display: flex; gap: 1rem; margin-top: 1.5rem;">
                    <button type="submit" class="btn btn-primary" style="flex: 1;">Simpan Kategori</button>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        form.addEventListener('submit', (e) => {
            ...
            if (!isValid) {
                e.preventDefault();
                alert('Silakan perbaiki kesalahan validasi sebelum menyimpan kategori.');
            }
        });
    });
</script>
